...
export const categorySchema = Type.Object(
  {
    ...
    parentCategoryId: Type.Optional(Type.Number())
  },
...
export const categoryDataSchema = Type.Pick(categorySchema, ['name', 'description', 'parentCategoryId'], {
  $id: 'CategoryData',
...
export const categoryQueryProperties = Type.Pick(categorySchema, ['id', 'name', 'description', 'parentCategoryId'])
